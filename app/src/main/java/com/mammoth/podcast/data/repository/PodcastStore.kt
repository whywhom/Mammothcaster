...
class LocalPodcastStore(
    private val podcastDao: PodcastsDao = MammothCastApp.podcastsDao,
    private val podcastFollowedEntryDao: PodcastFollowedEntryDao = MammothCastApp.podcastFollowedEntryDao,
