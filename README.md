...
Using the example of the home screen in the [`com.mammoth.caster.ui.home`](mobile/src/main/java/com/example/caster/ui/home) package:
...
- __Home:__ [`com.mammoth.caster.ui.home`](mobile/src/main/java/com/example/caster/ui/home)
- __Discover:__ [`com.mammoth.caster.ui.home.discover`](mobile/src/main/java/com/example/caster/ui/home/discover)
- __Podcast Category:__ [`com.mammoth.caster.ui.category`](mobile/src/main/java/com/example/caster/ui/home/category)
...
The podcast data in this sample is dynamically fetched from a number of podcast RSS feeds, which are listed in [`Feeds.kt`](mobile/src/main/java/com/example/caster/data/Feeds.kt). 
...
The [`PodcastRepository`][podcastrepo] class is responsible for handling the data fetching of all podcast information:
 ...
 The sample allows users to 'follow' podcasts, which is implemented within the data layer in the [`PodcastFollowedEntry`](mobile/src/main/java/com/example/caster/data/PodcastFollowedEntry.kt) entity class, and as functions in [PodcastStore][podcaststore]: `followPodcast()`, `unfollowPodcast()`.

 ### Date + time

 The sample uses the JDK 8 [date and time APIs](https://developer.android.com/reference/java/time/package-summary) through the [desugaring support][jdk8desugar] available in Android Gradle Plugin 4.0+. Relevant Room [`TypeConverters`](https://developer.android.com/reference/kotlin/androidx/room/TypeConverters) are implemented in [`DateTimeTypeConverters.kt`](mobile/src/main/java/com/example/caster/data/room/DateTimeTypeConverters.kt).
...
```
 ...
 [feeds]: mobile/src/main/java/com/example/caster/data/Feeds.kt
 [fetcher]: mobile/src/main/java/com/example/caster/data/PodcastFetcher.kt
 [podcastrepo]: mobile/src/main/java/com/example/caster/data/PodcastsRepository.kt
 [podcaststore]: mobile/src/main/java/com/example/caster/data/PodcastStore.kt
 [epstore]: mobile/src/main/java/com/example/caster/data/EpisodeStore.kt
 [catstore]: mobile/src/main/java/com/example/caster/data/CategoryStore.kt
 [db]: mobile/src/main/java/com/example/caster/data/room/JetcasterDatabase.kt
 [homevm]: mobile/src/main/java/com/example/caster/ui/home/HomeViewModel.kt
 [homeui]: mobile/src/main/java/com/example/caster/ui/home/Home.kt
