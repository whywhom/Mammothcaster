...
package com.mammoth.podcast.core.data.di

import android.content.Context
import androidx.room.Room
import coil.ImageLoader
import com.mammoth.podcast.core.data.BuildConfig
...
import com.mammoth.podcast.core.data.repository.LocalCategoryStore
import com.mammoth.podcast.core.data.repository.LocalEpisodeStore
import com.mammoth.podcast.core.data.repository.LocalPodcastStore
...
object DataDiModule {
    ...
    fun provideDatabase(
        ...
        Room.databaseBuilder(context, MammothDatabase::class.java, MammothDataBase)
    ...
    @Provides
    @Dispatcher(MammothDispatchers.IO)
    @Singleton
    fun provideIODispatcher(): CoroutineDispatcher = Dispatchers.IO

    @Provides
    @Dispatcher(MammothDispatchers.Main)
    @Singleton
