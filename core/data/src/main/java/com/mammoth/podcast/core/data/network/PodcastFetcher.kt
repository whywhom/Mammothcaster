...
class PodcastsFetcher @Inject constructor(
     ...
     * Instead of fetching com.mammoth.podcast.core.data on every app open, we instead allow the use of 'stale'
...
/**
 * Map a Rome [SyndFeed] instance to our own [Podcast] com.mammoth.podcast.core.data class.
 */
...
/**
 * Map a Rome [SyndEntry] instance to our own [Episode] com.mammoth.podcast.core.data class.
 */
